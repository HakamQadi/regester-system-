...
face.addEventListener("click", () => {
        ...
        .add(
            {
                ...
                backgroundColor: switched ? "rgb(243,255,148)" : "rgb(110,240,225)"
            },
            500
        )
        .add(
            {
                ...
                backgroundColor: switched ? " rgb(255,255,255)" : "rgb(91, 56, 115)",
        ...
        .add(
            {
                ...
                d: [
                    {
                        value: switched ? eyeOpenL : eyeClosedL
                    }
                ]
            },
            "-=1200"
        ...
        .add(
            {
                ...
                d: [
                    {
                        value: switched ? eyeOpenR : eyeClosedR
                    }
                ]
            },
            "-=1210"
        ...
        .add(
            {
                ...
                d: [
                    {
                        value: switched ? mouthOpen : mouthClosed
                    }
                ]
            },
            "-=1210"
    ...
    } else if (switchBG.classList.contains("off-shadow")) {
        switchBG.classList.remove("off-shadow");
    }
    switchBG.classList.add(switched ? "on-shadow" : "off-shadow");
});
